...
function expressionMatter(a, b, c) {
  ...
  if (value1 > maximumValue) maximumValue = value1;
  if (value2 > maximumValue) maximumValue = value2;
  if (value3 > maximumValue) maximumValue = value3;
  if (value4 > maximumValue) maximumValue = value4; 
  if (value5 > maximumValue) maximumValue = value5; 
  if (value6 > maximumValue) maximumValue = value6; 
